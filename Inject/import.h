...
typedef struct _SYSTEM_THREAD_INFORMATION
{
	...
	//KWAIT_REASON WaitReason;//等待原因, KWAIT_REASON中的一个值	
	LARGE_INTEGER           KernelTime;
	LARGE_INTEGER           UserTime;
	LARGE_INTEGER           CreateTime;
	ULONG                   WaitTime;
...
EXTERN_C NTSYSAPI char* NTAPI PsGetProcessImageFileName(PEPROCESS Eprocess);
EXTERN_C NTKERNELAPI PVOID PsGetProcessSectionBaseAddress(IN PEPROCESS Process);

EXTERN_C NTSYSAPI PVOID
...
EXTERN_C NTKERNELAPI HANDLE NTAPI PsGetProcessInheritedFromUniqueProcessId(PEPROCESS pEprocess);
